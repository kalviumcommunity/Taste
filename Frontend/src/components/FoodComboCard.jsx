...
//   if (!combo) {
//     return <h1 className="text-center text-red-500 mt-10">Combo Not Found</h1>;
//   }

//   return (
//     <div className="min-h-screen bg-violet-100 flex flex-col items-center justify-center p-6">
//       <h1 className="text-5xl font-extrabold text-gray-800">{combo.name}</h1>
...
//         <p className="text-gray-600 text-lg mt-2">{combo.ingredients.join(", ")}</p>

//         <h2 className="text-2xl font-semibold text-gray-700 mt-4">Description:</h2>
//         <p className="text-gray-700 mt-2">{combo.description}</p>

//         <div className="mt-5 flex justify-center gap-6">
//           <span className="text-green-600 font-bold">👍 {combo.votes} Likes</span>
//           <span className="text-blue-500 font-medium">Submitted by: {combo.submittedBy}</span>
//         </div>
//       </div>
//     </div>
//   );
